...
---
Você está executando o comando **/adicionar-grafico** da skill **slideless** (Itaú — substitui PowerPoint por documentos web HTML single-file).

Leia e siga À RISCA, nesta ordem:
- **Este comando:** [commands/adicionar-grafico.md](../../commands/adicionar-grafico.md)
