...
---
Você está executando o comando **/aplicar-tema** da skill **slideless** (Itaú — substitui PowerPoint por documentos web HTML single-file).

Leia e siga À RISCA, nesta ordem:
- **Este comando:** [commands/aplicar-tema.md](../../commands/aplicar-tema.md)
