...
1. Ler [../references/importar-conteudo.md](../references/importar-conteudo.md#confluence--handbook-default--hub).

## Procedimento

1. **Acesso:** se URL exigir autenticação, NÃO tentar fetch direto. Pedir export `.html` ou `.pdf` do Confluence ou texto colado.
2. **Triagem:**
   - Página única → [slideless-handbook](slideless-handbook.md) por default.
   - Espaço com várias páginas → [slideless-hub](slideless-hub.md) (cards) ou [slideless-site](slideless-site.md) (views) — perguntar.
