...
6. Validar (categoria P) + checklist (bloco 🎨) + gate perceptual se disponível. Entregar em `outputs/scrollytelling-<slug>.html` e reportar o parti em 1 linha. Seguir o passo-a-passo de [../references/workflow.md](../references/workflow.md).
