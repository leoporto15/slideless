...
### Q5 — Voz (header "Voz")
"Como esse documento deve soar?" *(se a pessoa não souber, sugerir pelo assunto — tabela de registros em [../references/direcao-de-arte.md](../direcao-de-arte.md) §1 — e pedir confirmação de 1 clique)*
...
- Usuário só quer editar documento existente → recomendar `/adicionar-*`, `/slideless polir`, `/slideless auditar`, etc.
- Usuário tem conteúdo estruturado e sabe o modelo → recomendar `/slideless estruturar` + `/slideless <modelo>`
